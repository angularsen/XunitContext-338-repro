...
public class UnitTest3 : MyTestBase, IClassFixture<WebApplicationFactory<Program>>, IAsyncLifetime
{
    private readonly TestServer _server;

    public UnitTest3(WebApplicationFactory<Program> factory, ITestOutputHelper output) : base(output)
    {
    ...
    {
        await Task.Delay(Random.Shared.Next(300, 800)).ConfigureAwait(false);
